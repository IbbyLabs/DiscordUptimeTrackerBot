...
def test_the_board_heading_makes_the_same_split_as_the_panel() -> None:
    ...
    head = _with_outages(cast(Any, stub), {}, ["rest"], translator_for(None))[0]
...
def test_the_board_heading_is_unchanged_when_nothing_is_recovering() -> None:
    ...
    assert _with_outages(cast(Any, stub), {}, [], translator_for(None))[0] == "**Active outages** — 1 service not responding"
